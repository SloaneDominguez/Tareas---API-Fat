...
// DELETE /api/tareas/:id — eliminar (RETO DE LA SESIÓN)
// Principio aplicado: validación de parámetros de entrada antes de operar,
// y respuesta con el código de estado HTTP correcto según el resultado.
router.delete(
  '/:id',
  param('id').isInt(),
  validar,
  (req, res) => {
    ...
    res.status(204).send(); // 204: eliminado con éxito, sin contenido en la respuesta
  }
);
